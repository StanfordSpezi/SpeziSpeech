...
The [`Speech`](https://swiftpackageindex.com/stanfordspezi/spezispeech/documentation/spezispeech/speech) component needs to be registered in a Spezi-based application using the 
